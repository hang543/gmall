...
public class MemberReceiveAddressController {
    ...
    public Resp<List<MemberReceiveAddressEntity>> queryAdderessesByUserId(@PathVariable("userId") Long userId){
        List<MemberReceiveAddressEntity> entityList = this.memberReceiveAddressService.list(new QueryWrapper<MemberReceiveAddressEntity>().eq("member_id", userId));
        return Resp.ok(entityList);
    }
