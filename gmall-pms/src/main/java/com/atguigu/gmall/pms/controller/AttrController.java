...
public class AttrController {
    ...
    @GetMapping
    public Resp<PageVo> queryAttrsById(QueryCondition queryCondition,@RequestParam("cid")Long cid,@RequestParam(value = "type",defaultValue = "1") Integer type) {
        PageVo page = attrService.queryAttrsById(queryCondition,cid,type);
