...
public class SkuSaleAttrValueController {
    ...
    public Resp<List<SkuSaleAttrValueEntity>> querySkuSaleAttrValuesById(@PathVariable("spuId") Long spuId) {
        List<SkuSaleAttrValueEntity> attrValueEntityList = this.skuSaleAttrValueService.querySkuSaleAttrValuesById(spuId);
    ...
    public Resp<List<SkuSaleAttrValueEntity>> querySkuSaleAttrValuesBySkuId(@PathVariable("skuId") Long skuId) {
        List<SkuSaleAttrValueEntity> saleAttrValueEntities = this.skuSaleAttrValueService.list(new QueryWrapper<SkuSaleAttrValueEntity>().eq("sku_id", skuId));
